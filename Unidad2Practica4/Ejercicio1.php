...
echo "Elemento con índice 5: " . $coches[5] . "<br>";

// b)
$importe = [32.583, 11.239, 45.781, 22.237];
echo "Elemento con índice 1: " . $importe[1] . "<br>";
echo "Elemento con índice 3: " . $importe[3] . "<br>";

// c)
$confirmado = [true, true, false, true, false, false];
echo "Elemento con índice 0: " . ($confirmado[0] ? 'true' : 'false') . "<br>";
