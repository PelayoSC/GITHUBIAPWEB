<?php
/* 
a) Haz una matrix 4x3 con numeros aleatorios del 1 al 100. 
...
<head>
    ...
    <title>Matriz 4x3 y Cálculos</title>
    <style>
        table {
...
<body>
    <h1>Matriz 4x3 y Cálculos</h1>
    <?php
    // a) Generar la matriz 4x3 con números aleatorios
    $filas = 4;
    $columnas = 3;
    $matriz = [];
    ...
    // g) Calcular la suma de cada fila
    ...
    // h) Calcular la suma de cada columna
